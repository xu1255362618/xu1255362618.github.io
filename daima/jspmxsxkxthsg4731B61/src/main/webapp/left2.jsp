	...
	<div class="container">
		...
		<div class="leftsidebar_box"><a href="sy.jsp" target="main"><div class="line"><img src="images/coin01.png" />&nbsp;&nbsp;首页</div></a>
			<dl class="system_log">
				...
				<dd>
					<img class="coin11" src="images/coin111.png" /><img class="coin22" src="images/coin222.png" /><a class="cks" href="xuesheng_updt2.jsp" target="main">个人资料管理</a><img class="icon5" src="images/coin21.png" />
				</dd>
			...
			<dl class="system_log">
				...
				<dd>
					<img class="coin11" src="images/coin111.png" /><img class="coin22" src="images/coin222.png" /><a class="cks" href="kechengxinxi_list00.jsp" target="main">课程查看</a><img class="icon5" src="images/coin21.png" />
				</dd>
			...
			<dl class="system_log">
				...
				<dd>
					<img class="coin11" src="images/coin111.png" /><img class="coin22" src="images/coin222.png" /><a class="cks" href="xuanke_list2.jsp" target="main">选课记录</a><img class="icon5" src="images/coin21.png" />
				</dd>
			</dl>
			<dl class="system_log">
				<dt>
				...
				<dd>
					<img class="coin11" src="images/coin111.png" /><img class="coin22" src="images/coin222.png" /><a class="cks" href="chengjixinxi_list2.jsp" target="main">我的成绩</a><img class="icon5" src="images/coin21.png" />
				</dd>
			</dl>
