...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
 ...
 <% 
    ...
    String sql =  "select * from kechengxinxi where gonghao='"+request.getSession().getAttribute("username")+"' ";
...
if (request.getParameter("xuefen2")==""  ||request.getParameter("xuefen2")==null ) {}else {sql=sql+" and xuefen <= '"+request.getParameter("xuefen2")+"'";}
 ...
 <td><%=map.get("xuankerenshu") %></td>
    ...
    <td width="60" align="center"><a href="kechengxinxi_updt.jsp?id=<%=map.get("id")%>">修改</a>  <a href="kechengxinxi_list2.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a> <a href="kechengxinxi_detail.jsp?id=<%=map.get("id")%>">详细</a> </td>
  </tr>
  	<%
  }
   %>
